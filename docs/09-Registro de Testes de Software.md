...
|Resultados obtidos | O cliente consegue visualizar os dias e horários disponíveis corretamente |
| Conclusão | Resultado satisfatório|
|Melhorias e recomendações | N/A|
...
|Resultados obtidos |   O estabelecimento é registrado com sucesso. |
| Conclusão | Resultado satisfatório|
|Melhorias e recomendações | N/A|
...
|Resultados obtidos |   O estabelecimento consegue visualizar corretamente a lista de agendamentos marcados. |
| Conclusão | Resultado satisfatório|
|Melhorias e recomendações | N/A|
